...
class ViewTextStackAction extends Action
{
    ...
    public function handle(ActionFields $fields, Collection $models): Action|ActionResponse
    {
        return ModalResponse::stack([
            ...
            Block::heading('Badge sizes')->small(),
            Block::inline([
                Block::badge('Small')->success()->small(),
                Block::badge('Medium')->success(),
                Block::badge('Large')->success()->large(),
            ]),
            ...
            Block::heading('Icon sizes')->small(),
            Block::inline([
                Block::icon('check-circle')->success()->small(),
                Block::icon('check-circle')->success(),
                Block::icon('check-circle')->success()->large(),
            ]),
            Block::divider(),
            ...
            Block::heading('Link sizes')->small(),
            Block::inline([
                Block::link('Small', 'https://nova.laravel.com')->small(),
                Block::link('Medium', 'https://nova.laravel.com'),
                Block::link('Large', 'https://nova.laravel.com')->large(),
            ]),
            Block::inline([
                Block::link('Small', 'https://nova.laravel.com')->button()->small(),
                Block::link('Medium', 'https://nova.laravel.com')->button(),
                Block::link('Large', 'https://nova.laravel.com')->button()->large(),
            ]),
